...
#include <unistd.h> //for fork and pipe stuff
...
int main(int argc, char* argv[])
{
    ...
    //Creat the pipe before the fork so that the child
    ...
    if(pid != 0)
    {
        ...
        //the read end of pipe and begin writing data.
        close(fd[READ_END]);
        char *str1 = "printing to the pipe.\0";
        char *str2 = "putting more in pipe.\0";

        printf("Parent wrinting: %s\n", str1);
